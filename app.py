...
def build_system_prompt():
    ...
    return (
        ...
        "\n"
        "SOBRE A ANJE: " + inst.get('sobre', 'Associacao de direito privado e utilidade publica.') + "\n"
        "SOBRE A ANJE FORMACAO: " + inst.get('sobre_formacao', 'Formacao Profissional Certificada para empreendedores e empresas.') + "\n"
        "\n"
